...
seo:
  ...
  no_index: false
---
Before we<br> dive into the formatting feast, let's talk about markdown5

<p class="align-center">Before we<br /> dive into the formatting feast, let's talk about markdown6</p>

<p class="align-right">Before we<br /> dive into the formatting feast, let's talk about markdown7</p>

<p class="align-justify">Before we<br /> dive into the formatting feast, let's talk about markdown8</p>
